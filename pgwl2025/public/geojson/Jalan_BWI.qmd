...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" type="Local Area Network" url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" mimeType="" description="" format="" name="File Geodatabase Feature Class"/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial maxz="0" minz="0" maxx="0" maxy="0" dimensions="2" minx="0" crs="EPSG:4326" miny="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
